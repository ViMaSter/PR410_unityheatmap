...
public class RequestTest
{
    ...
    {
    	Assert.That(
    		"{\"command\":\"createSession\",\"session\":{\"playerPositionX\":-1.0,\"playerPositionY\":10.0,\"health\":20.0},\"player\":{\"playerPositionX\":-1.0,\"playerPositionY\":10.0,\"health\":20.0}}", Does.Match(JsonUtility.ToJson(
